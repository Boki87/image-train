  ...
  try {
    ...
    for (let i = 0; i < images.length; i++) {
      ...
      for (let a = 0; a < actions.length; a++) {
        ...
        switch (action.type) {
          case 'flatten':
            await sharp(tempIncrementImage).flatten(action.params).toFile(tempIncrementedImage)
            break
          case 'resize':
            ...
            break
          case 'extend':
            await sharp(tempIncrementImage).extend(action.params).toFile(tempIncrementedImage)
            break
          case 'extract':
